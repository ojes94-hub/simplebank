...
func (store *Store) UpdateTransferBalances(ctx context.Context, accountID1 int64, amount1 int64, accountID2 int64, amount2 int64) (account1 Account, account2 Account, err error) {
	err = store.execTx(ctx, func(q *Queries) error {
		var err error
